export default class MenuActive {
  constructor() {
    this.menuActive = document.querySelectorAll('.container-nav .nav ul li'); // Está selecionando todos os elementos que contém a classe container-nav e dentro dela a classe nav e dentro dela a tag ul e dentro dela a tag li.
